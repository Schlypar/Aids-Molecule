...
public:
	...
	{
		AbstractIterator<T>* iter = new IteratorWrapper<SegmentedList<T>>(this->container.begin());
		return Iterator(iter);
	}

	Iterator end() override
	{
		AbstractIterator<T>* iter = new IteratorWrapper<SegmentedList<T>>(this->container.end());
		return Iterator(iter);
	}
