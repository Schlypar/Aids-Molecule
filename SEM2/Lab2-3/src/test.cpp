...
int main()
{
   ...
   TreePtr<int,int> tree = (Tree<int, int>*) new BinaryTree<int, int>(1, [](int value) -> int { return value * value / 2 - 1 - value; } );
    tree->Add(2)->Add(5);
   ...
   TreePtr<int,int> res = copy->Map([](int& value) -> int { value = value * 10; return value; });
